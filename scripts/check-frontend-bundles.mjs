    ...
    entries: [
      {
        ...
        mustStayDynamic: [
          ...
          { key: 'DesktopLogin', source: 'src/components/DesktopLogin.tsx' },
          'src/components/PasswordLoginForm.tsx',
          'src/pages/DashboardPage.tsx',
          {
            key: 'DeveloperPlatformLayout',
            source: 'src/pages/developer/DeveloperPlatformLayout.tsx',
          },
          'src/pages/developer/DeveloperApplicationsPage.tsx',
          'src/pages/developer/DeveloperDevelopPage.tsx',
          'src/pages/developer/DeveloperUploadPage.tsx',
          'src/pages/developer/DeveloperVersionsPage.tsx',
          'src/pages/developer/DeveloperLogsPage.tsx',
          'src/pages/developer/DeveloperAnalyticsPage.tsx',
